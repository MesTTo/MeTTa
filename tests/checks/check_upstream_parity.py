...
Guarantees:
  - every program is paired with a freshly measured null, so artifacts
    ...
    cost [tested: check_upstream_parity_selftest.fresh_null_failures; commit=WORKTREE]
  - live comparisons start with the boot's purge and shipping qlf_load_engine
    ...
    check_upstream_parity_selftest.artifact_fixture_failures; commit=WORKTREE]
  ...
  - the compared range subtracts the null maximum from the program minimum
    ...
    [tested: check_upstream_parity_selftest.null_range_failures; commit=WORKTREE]
