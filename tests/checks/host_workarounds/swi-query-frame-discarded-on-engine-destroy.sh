...
#   remains an error [tested: sh tools/check.sh host-workarounds; commit=5a1127efe0f575668061e8a24c59b8ab60e6122a].
...
#  three runs of three; command=sh tools/check.sh host-workarounds;
