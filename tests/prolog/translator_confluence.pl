...
%       lib/lib_nars/pkg.metta, which the character-level parser in engine/parser.pl
...
shipped_library('../../lib/lib_patrick/pkg.metta').
shipped_library('../../lib/lib_spaces/pkg.metta').
