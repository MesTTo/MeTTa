...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','','$alias_base'),(catch(lib_gitimport:acquire_git_dependency('file://$fixture/a','$a2','','$alias_base'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_url_alias_conflict,none))),halt"
...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_build_base'),(catch(lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','build.sh','$spec_build_base'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_build_spec_conflict,none))),halt"

spec_base_a="$fixture/spec-base-a"
spec_base_b="$fixture/spec-base-b"
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_base_a'),(catch(lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_base_b'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_base_spec_conflict,none))),halt"
...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),lib_gitimport:acquire_git_dependency('file://$fixture/a.git','$a1','build.sh','$space_base'),halt"
...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),(catch(lib_gitimport:acquire_git_dependency('file://$fixture/retry-parent.git','$retry_parent_sha','','$retry_parent_base_a'),_,fail)->throw(error(expected_first_failure,none));true),(lib_gitimport:git_library_path('retry-parent',_)->throw(error(stale_parent_registration,none));true),rename_file('$fixture/retry-leaf.git.ready','$fixture/retry-leaf.git'),lib_gitimport:acquire_git_dependency('file://$fixture/retry-parent.git','$retry_parent_sha','','$retry_parent_base_b'),halt"
