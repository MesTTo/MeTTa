...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),acquire_git_dependency('file://$fixture/a.git','$a1','','$alias_base'),(catch(acquire_git_dependency('file://$fixture/a','$a2','','$alias_base'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_url_alias_conflict,none))),halt"
...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_build_base'),(catch(acquire_git_dependency('file://$fixture/a.git','$a1','build.sh','$spec_build_base'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_build_spec_conflict,none))),halt"

spec_base_a="$fixture/spec-base-a"
spec_base_b="$fixture/spec-base-b"
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_base_a'),(catch(acquire_git_dependency('file://$fixture/a.git','$a1','','$spec_base_b'),E,true),nonvar(E),E=error(domain_error(conflicting_git_dependency,_),_)->true;throw(error(expected_base_spec_conflict,none))),halt"
...
bounded swipl -q -g "consult('$ROOT/engine/main.pl'),acquire_git_dependency('file://$fixture/a.git','$a1','build.sh','$space_base'),halt"
