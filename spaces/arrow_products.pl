...
%module [source: engine/ext_points.pl:kind/2; commit=WORKTREE].
...
%whole list [tested: extensions/python/tests/ch07_control_flow/test_control_signals.py; commit=WORKTREE].
