...
% and host validation [tested: test_tensor_type_carrier_runs_max_product_and_reinterprets_provenance; commit=074dc0a88b1605c54824de677d586b6f60998bcf].
% Assumes:
...
:- module(spaces,
          [
            ...
            metta_store_occurrence/4,
            metta_remove_occurrence/3,
            metta_host_blame/3,
            ...
            metta_reference_mutation_scope/2,
            metta_reference_lazy_equations/2,
            result_finality/2,
