...
GENERATED_ARTIFACT_LANES="layer-sync vocab-sync artifact-sync binding bounds-sync codec-doc example-origins face-sync prolog-face pygments-sync refusal-sync aio-mirror fn-sync libdoc refusals init-stub door-sync ledger phrasebook reference"
WANT="$*"
case " $WANT " in
