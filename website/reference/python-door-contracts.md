...
Generated by `extensions/python/tools/doorgen.py` from `@door` marks beside core and provider bodies.
...
Implementation: `metta._spaces.context:MeTTaBase.close`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.closed`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.self`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _root.Space)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.runtime`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context Runtime)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.info`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.context dict) (String (host-union ((host-union (String Number)) NoneType))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.lock`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _root.Lock)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.check`, receiving `method`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `lock` | `(host-type metta._spaces.context _root.Lock)` | `required` | `values` | `positional_or_keyword` |

Guarantees result type `(host-apply (host-type metta._spaces.context list) ((host-type metta._spaces.context _root.Drift)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.space`, receiving `method`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `name` | `(host-union ((host-union ((host-union ((host-union (String Symbol)) Expression)) (host-type metta._spaces.context _root.Space))) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `backing` | `%Undefined%` | `None` | `values` | `positional_or_keyword` |
| `inherits` | `(host-union ((host-type metta._spaces.context _root.Space) NoneType))` | `None` | `values` | `keyword_only` |
| `restricted` | `Bool` | `False` | `values` | `keyword_only` |
| `grants` | `(host-apply (host-type metta._spaces.context _abc.Iterable) (String))` | `()` | `values` | `keyword_only` |
| `journal` | `(host-union ((host-union (String (host-apply (host-type metta._spaces.context os.PathLike) (String)))) NoneType))` | `None` | `values` | `keyword_only` |
| `schema` | `(host-union ((host-apply (host-type metta._spaces.context _abc.Mapping) (String %Undefined%)) NoneType))` | `None` | `values` | `keyword_only` |
| `sync` | `(host-type metta._spaces.context JournalSync)` | `JournalSync.none` | `values` | `keyword_only` |
| `rename` | `(host-union ((host-apply (host-type metta._spaces.context _abc.Mapping) (String String)) NoneType))` | `None` | `values` | `keyword_only` |
| `_created_at` | `(host-union ((host-apply (host-type metta._spaces.context tuple) (String Number)) NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._spaces.context:MeTTaBase.fn`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _declare.functions._FunctionNamespace)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.unregister_op`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.capture`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _spaces_execution.CapturedOutput)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.atomic`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _spaces_execution.ScopedExecution)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.scope`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.context _root.parallel.Scope)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.transaction`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.register_prolog`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.context tuple) (String ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.context:MeTTaBase.register_foreign_library`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.register_library_path`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.unregister_prolog`, receiving `method`.
...
Implementation: `metta._spaces.context:MeTTaBase.prolog`, receiving `method`.
...
| `answer` | `(host-union ((host-type metta._spaces.evaluate EvaluationAnswer) String))` | `'all'` | `values` | `keyword_only` |
| `delivery` | `(host-union ((host-type metta._spaces.evaluate ArgumentDelivery) String))` | `'atoms'` | `values` | `keyword_only` |
| `limit` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `image` | `(host-union ((host-union ((host-type metta._spaces.evaluate ImageMode) String)) NoneType))` | `None` | `values` | `keyword_only` |
| `on_error` | `(host-union ((host-type metta._spaces.evaluate OnError) String))` | `'keep'` | `values` | `keyword_only` |
| `determinism` | `(host-union ((host-type metta._spaces.evaluate Determinism) String))` | `'nondet'` | `values` | `keyword_only` |
...
Guarantees result type `(host-apply (host-type metta._spaces.evaluate _root.Answers) (%Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.evaluate:parallel`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._spaces.evaluate list) ((host-union (Atom (host-type metta._spaces.evaluate Undefined)))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.evaluate:pool`, receiving `space`.
...
Implementation: `metta._spaces.evaluate:reducible`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._spaces.evaluate list) ((host-apply (host-type metta._spaces.evaluate tuple) (String (host-union ((host-union (Atom (host-type metta._spaces.evaluate Undefined))) NoneType))))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.evaluate:run_status`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._spaces.evaluate list) ((host-apply (host-type metta._spaces.evaluate list) ((host-apply (host-type metta._spaces.evaluate tuple) (String (host-union ((host-union (Atom (host-type metta._spaces.evaluate Undefined))) NoneType))))))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.evaluate:one`, receiving `space`.
...
Implementation: `metta._spaces.evaluate:first`, receiving `space`.
...
Implementation: `metta._spaces.handle:SpaceHandle.name`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.handle _SpaceId)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.self`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.handle Self)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.space_names`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.handle list) (String))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.drop`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.dropped`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.to_wire`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.handle list)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.metatype`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.bind`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.runtime`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.handle Runtime)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.metta`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.handle _root.MeTTa)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.alpha`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.alpha_eq`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.args`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.handle tuple) (Atom ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.children`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.eq`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.ge`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.gt`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.head`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.le`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.lt`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.map`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `transform` | `(host-apply (host-type metta._spaces.handle Callable) ((Atom) Atom))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.handle:SpaceHandle.ne`, receiving `method`.
...
Implementation: `metta._spaces.handle:SpaceHandle.subs`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `bindings` | `(host-union ((host-apply (host-type metta._spaces.handle Mapping) (Atom %Undefined%)) %Undefined%))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.handle:SpaceHandle.unify`, receiving `method`.
...
Guarantees result type `(host-union ((host-apply (host-type metta._spaces.handle Mapping) (Atom Atom)) NoneType))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.vars`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.handle tuple) (Variable ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.handle:SpaceHandle.value`, receiving `method`.
...
Implementation: `metta._spaces.profile:profile`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `source` | `(host-union (String (host-type metta._spaces.profile TemplateLike)))` | `required` | `values` | `positional_only` |
| `timeout` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `inferences` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `values` | `%Undefined%` | `required` | `values` | `var_keyword` |

Guarantees result type `(host-apply (host-type metta._spaces.profile tuple) ((host-apply (host-type metta._spaces.profile list) ((host-apply (host-type metta._spaces.profile list) (Atom)))) (host-type metta._spaces.profile EngineProfile)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.profile:profile_extension`, receiving `space`.
...
| `names` | `(host-union ((host-apply (host-type metta._spaces.profile _abc.Sequence) (String)) NoneType))` | `None` | `values` | `keyword_only` |
| `timeout` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `inferences` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `values` | `%Undefined%` | `required` | `values` | `var_keyword` |

Guarantees result type `(host-apply (host-type metta._spaces.profile tuple) ((host-apply (host-type metta._spaces.profile list) ((host-apply (host-type metta._spaces.profile list) (Atom)))) (host-apply (host-type metta._spaces.profile list) ((host-type metta._spaces.profile FunctionCost)))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.profile:stats`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.profile _StatsBlock)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.query:match`, receiving `space`.
...
Implementation: `metta._spaces.query:stream`, receiving `space`.
...
Implementation: `metta._spaces.query:solve`, receiving `space`.
...
Implementation: `metta._spaces.query:prepare`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.query Prepared)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.insert`, receiving `method`.
...
| `item` | `(host-apply (host-type metta._spaces.results Iterable) (%Undefined%))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.results:Rows.append`, receiving `method`.
...
Implementation: `metta._spaces.results:Rows.extend`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `other` | `(host-apply (host-type metta._spaces.results Iterable) ((host-apply (host-type metta._spaces.results Iterable) (%Undefined%))))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.results:Rows.copy`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.results Rows)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.column`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.results Column)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.group_by`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results dict) (Atom (host-type metta._spaces.results Rows)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.first`, receiving `method`.
...
Guarantees result type `(host-union ((host-type metta._spaces.results Row) %Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.one`, receiving `method`.
...
Implementation: `metta._spaces.results:Rows.raise_for_errors`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.results Self)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.why`, receiving `method`.
...
Implementation: `metta._spaces.results:Rows.explain`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.results _spaces_profile.Explanation)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.build`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `column` | `(host-union (String (host-type metta._spaces.results type)))` | `required` | `values` | `positional_or_keyword` |
| `cls` | `(host-union ((host-type metta._spaces.results type) NoneType))` | `None` | `values` | `positional_or_keyword` |

Guarantees result type `(host-type metta._spaces.results list)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.into`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `cls` | `(host-type metta._spaces.results type)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.results:Rows.to_dicts`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results list) ((host-apply (host-type metta._spaces.results dict) (String %Undefined%))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.table`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results dict) (String (host-apply (host-type metta._spaces.results list) (%Undefined%))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.arrow`, receiving `method`.
...
Guarantees result type `(host-type metta._spaces.results ArrowView)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Rows.to`, receiving `method`.
...
Implementation: `metta._spaces.results:Rows.pipe`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-apply (host-type metta._spaces.results Callable) (... %Undefined%))` | `required` | `values` | `positional_or_keyword` |
| `args` | `%Undefined%` | `required` | `values` | `var_positional` |
| `kwargs` | `%Undefined%` | `required` | `values` | `var_keyword` |
...
Implementation: `metta._spaces.results:Rows.render`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.columns`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results tuple) (String ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Answers.index`, receiving `method`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `value` | `(host-type metta._spaces.results T)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.results:Answers.column`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results Answers) (%Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Answers.group_by`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.rows`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results Answers) ((host-type metta._spaces.results Row)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Answers.into`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.build`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta._spaces.results list) (%Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.results:Answers.to_dicts`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.table`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.to`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.arrow`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.pipe`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.raise_for_errors`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.why`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.explain`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.render`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.one`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.first`, receiving `method`.
...
Implementation: `metta._spaces.results:Answers.close`, receiving `method`.
...
Implementation: `metta._spaces.scope:assuming`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.scope _Assuming)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.scope:transaction`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `target` | `(host-union ((host-apply (host-type metta._spaces.scope Callable) (() (host-type metta._spaces.scope _R))) %Undefined%))` | `required` | `values` | `positional_only` |
...
Implementation: `metta._spaces.scope:limits`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.scope ScopedLimits)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.scope:capture`, receiving `space`.
...
Implementation: `metta._spaces.scope:scope`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.scope _root.parallel.Scope)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.scope:atomic`, receiving `space`.
...
Implementation: `metta._spaces.scope:speculative`, receiving `space`.
...
Implementation: `metta._spaces.scope:batch`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.scope _Batch)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.scope:transactional`, receiving `space`.

Assumes receiver state `any`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-apply (host-type metta._spaces.scope Callable) ((host-type metta._spaces.scope _P) (host-type metta._spaces.scope _R)))` | `required` | `values` | `positional_only` |

Guarantees result type `(host-apply (host-type metta._spaces.scope Callable) ((host-type metta._spaces.scope _P) (host-type metta._spaces.scope _R)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.source:run`, receiving `space`.
...
| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `source` | `(host-union (String (host-type metta._spaces.source TemplateLike)))` | `required` | `values` | `positional_only` |
| `timeout` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `inferences` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `values` | `%Undefined%` | `required` | `values` | `var_keyword` |

Guarantees result type `(host-apply (host-type metta._spaces.source list) ((host-apply (host-type metta._spaces.source list) (Atom))))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.source:save`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `path` | `(host-union (String (host-apply (host-type metta._spaces.source os.PathLike) (String))))` | `required` | `values` | `positional_or_keyword` |
| `format` | `(host-type metta._spaces.source SaveFormat)` | `SaveFormat.metta` | `values` | `keyword_only` |
| `timeout` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `inferences` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._spaces.source:source`, receiving `space`.
...
Implementation: `metta._spaces.source:load`, receiving `space`.
...
Implementation: `metta._spaces.source:parse`, receiving `space`.
...
Implementation: `metta._spaces.source:register_token`, receiving `space`.
...
| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `pattern` | `(host-union (String (host-apply (host-type metta._spaces.source _re.Pattern) (String))))` | `required` | `values` | `positional_or_keyword` |
| `constructor` | `(host-apply (host-type metta._spaces.source Callable) ((String) %Undefined%))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._spaces.source:unregister_token`, receiving `space`.
...
Implementation: `metta._spaces.source:_repr_html_`, receiving `space`.
...
Implementation: `metta._spaces.store:add`, receiving `space`.
...
Implementation: `metta._spaces.store:remove`, receiving `space`.
...
Implementation: `metta._spaces.store:transfer`, receiving `space`.
...
|---|---|---|---|---|
| `atoms` | `%Undefined%` | `required` | `values` | `var_positional` |
| `to` | `(host-type metta._spaces.store _root.Space)` | `required` | `values` | `keyword_only` |
...
Implementation: `metta._spaces.store:atoms`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._spaces.store list) (Atom))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.store:peek`, receiving `space`.
...
Implementation: `metta._spaces.store:take`, receiving `space`.
...
Implementation: `metta._spaces.store:cast`, receiving `space`.
...
Implementation: `metta._spaces.store:copy`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.store _root.Space)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.store:digest`, receiving `space`.
...
Implementation: `metta._spaces.store:__len__`, receiving `space`.
...
Implementation: `metta._spaces.store:__bool__`, receiving `space`.
...
Implementation: `metta._spaces.store:__contains__`, receiving `space`.
...
Implementation: `metta._spaces.store:clear`, receiving `space`.
...
Implementation: `metta._spaces.store:__iadd__`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.store _SpaceT)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.store:__isub__`, receiving `space`.
...
Implementation: `metta._spaces.store:__ior__`, receiving `space`.
...
Implementation: `metta._spaces.store:__iter__`, receiving `space`.
...
Implementation: `metta._spaces.store:__getitem__`, receiving `space`.
...
Guarantees result type `(host-type metta._spaces.store _root.Rows)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._spaces.store:__delitem__`, receiving `space`.
...
Implementation: `metta._spaces.subscriptions:watch`, receiving `space`.
...
|---|---|---|---|---|
| `pattern` | `%Undefined%` | `required` | `values` | `positional_or_keyword` |
| `on` | `(host-type metta._spaces.subscriptions SubscriptionEdge)` | `SubscriptionEdge.add` | `values` | `keyword_only` |
| `where` | `(host-union (%Undefined% NoneType))` | `None` | `values` | `keyword_only` |
| `deadline` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._spaces.subscriptions:subscribe`, receiving `space`.
...
|---|---|---|---|---|
| `pattern` | `%Undefined%` | `required` | `values` | `positional_or_keyword` |
| `callback` | `(host-union ((host-type metta._spaces.subscriptions Callable) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `on` | `(host-type metta._spaces.subscriptions SubscriptionEdge)` | `SubscriptionEdge.add` | `values` | `keyword_only` |
| `where` | `(host-union (%Undefined% NoneType))` | `None` | `values` | `keyword_only` |
| `queue_max` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._declare.declarations:integrate`, receiving `space`.
...
Implementation: `metta._declare.declarations:handles`, receiving `space`.
...
| `fidelity` | `(host-type metta._declare.declarations Fidelity)` | `required` | `values` | `positional_or_keyword` |
| `det` | `(host-union ((host-type metta._declare.declarations Determinism) NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._declare.declarations:annotations`, receiving `space`.
...
| `capabilities` | `(host-apply (host-type metta._declare.declarations _abc.Iterable) (String))` | `()` | `values` | `keyword_only` |
...
Implementation: `metta._declare.declarations:algebra`, receiving `space`.
...
| `laws` | `(host-apply (host-type metta._declare.declarations _abc.Iterable) (String))` | `()` | `values` | `keyword_only` |
| `carrier` | `(host-apply (host-type metta._declare.declarations _abc.Iterable) (%Undefined%))` | `()` | `values` | `keyword_only` |
...
Implementation: `metta._declare.declarations:covers`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `effect` | `(host-union ((host-type metta._declare.declarations EffectClass) String))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:compensates`, receiving `space`.
...
Implementation: `metta._declare.declarations:add_tagged_fact`, receiving `space`.
...
Implementation: `metta._declare.declarations:add_tagged_rule`, receiving `space`.
...
Implementation: `metta._declare.declarations:image`, receiving `space`.
...
| `setting` | `(host-type metta._declare.declarations ImageMode)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:sample`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._declare.declarations list) (Atom))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.declarations:consumption`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `kind` | `(host-type metta._declare.declarations SourceKind)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:on_error`, receiving `space`.
...
| `mode` | `(host-union ((host-type metta._declare.declarations OnError) NoneType))` | `None` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:merge`, receiving `space`.
...
|---|---|---|---|---|
| `pattern` | `(host-union (String Atom))` | `required` | `values` | `positional_or_keyword` |
| `policy` | `(host-type metta._declare.declarations AnswerPolicy)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:context`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `world` | `(host-type metta._declare.declarations World)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:agenda`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `policy` | `(host-type metta._declare.declarations AgendaPolicy)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:reacts`, receiving `space`.
...
Implementation: `metta._declare.declarations:admits`, receiving `space`.
...
Implementation: `metta._declare.declarations:capacity`, receiving `space`.
...
Implementation: `metta._declare.declarations:atomicity`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `atomicity` | `(host-type metta._declare.declarations Atomicity)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.declarations:emits`, receiving `space`.
...
Implementation: `metta._declare.declarations:events`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `delivery` | `(host-union ((host-type metta._declare.declarations Delivery) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `order` | `(host-type metta._declare.declarations EventOrder)` | `EventOrder.unordered` | `values` | `positional_or_keyword` |
...
Implementation: `metta._declare.definitions:define`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-union ((host-apply (host-type metta._declare.definitions Callable) (... %Undefined%)) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `prolog` | `(host-union ((host-union (String (host-apply (host-type metta._declare.definitions os.PathLike) (String)))) NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._declare.definitions:rules`, receiving `space`.
...
Implementation: `metta._declare.definitions:pre_add`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-union ((host-apply (host-type metta._declare.definitions _root.Defined) (... %Undefined%)) (host-apply (host-type metta._declare.definitions Callable) (... %Undefined%))))` | `required` | `values` | `positional_or_keyword` |

Guarantees result type `(host-apply (host-type metta._declare.definitions _root.Defined) (... %Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.definitions:type`, receiving `space`.
...
Implementation: `metta._declare.definitions:infer_types`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._declare.definitions list) (Atom))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.definitions:doc`, receiving `space`.
...
Implementation: `metta._declare.functions:builtins`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._declare.functions list) (String))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.functions:is_function`, receiving `space`.
...
Implementation: `metta._declare.functions:is_function_here`, receiving `space`.
...
Implementation: `metta._declare.functions:arities`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._declare.functions list) (Number))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.functions:fn`, receiving `space`.
...
Guarantees result type `(host-type metta._declare.functions _FunctionNamespace)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.operations:op`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-union ((host-type metta._declare.operations Callable) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `name` | `(host-union (String NoneType))` | `None` | `values` | `keyword_only` |
| `transport` | `(host-type metta._declare.operations Transport)` | `'encoded'` | `values` | `keyword_only` |
| `effect` | `(host-union ((host-union ((host-type metta._declare.operations EffectClass) String)) NoneType))` | `None` | `values` | `keyword_only` |
| `declarations` | `(host-apply (host-type metta._declare.operations Iterable) (Atom))` | `()` | `values` | `keyword_only` |
| `arities` | `(host-union ((host-apply (host-type metta._declare.operations list) (Number)) NoneType))` | `None` | `values` | `keyword_only` |
| `inverse` | `(host-union ((host-type metta._declare.operations Callable) NoneType))` | `None` | `values` | `keyword_only` |
...
Implementation: `metta._declare.operations:pure`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `fn` | `(host-union ((host-type metta._declare.operations Callable) NoneType))` | `None` | `values` | `positional_only` |
...
Implementation: `metta._declare.operations:reads`, receiving `space`.
...
Implementation: `metta._declare.operations:writes`, receiving `space`.
...
Implementation: `metta._declare.operations:io`, receiving `space`.
...
Implementation: `metta._declare.operations:unregister_op`, receiving `space`.
...
| `path` | `(host-union ((host-union (String (host-apply (host-type metta._declare.prolog os.PathLike) (String)))) NoneType))` | `None` | `values` | `keyword_only` |
| `names` | `(host-union ((host-apply (host-type metta._declare.prolog _abc.Sequence) (String)) (host-apply (host-type metta._declare.prolog _abc.Mapping) (String String))))` | `()` | `values` | `keyword_only` |

Guarantees result type `(host-apply (host-type metta._declare.prolog tuple) (String ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._declare.prolog:register_foreign_library`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `path` | `(host-union (String (host-apply (host-type metta._declare.prolog os.PathLike) (String))))` | `required` | `values` | `positional_or_keyword` |
| `entry` | `(host-union (String NoneType))` | `None` | `values` | `keyword_only` |
| `names` | `(host-apply (host-type metta._declare.prolog _abc.Sequence) (String))` | `()` | `values` | `keyword_only` |
...
Implementation: `metta._declare.prolog:register_library_path`, receiving `space`.
...
Implementation: `metta._declare.prolog:unregister_prolog`, receiving `space`.
...
Implementation: `metta._declare.prolog:prolog`, receiving `space`.
...
Implementation: `metta._observe.debug:debug`, receiving `space`.
...
Guarantees result type `(host-type metta._observe.debug Debugger)` with the answer shape, effect, and determinism above.

Declared local refusals:

- `value`: `extensions/python/tests/ch14_seeing_your_program/test_debug.py::test_a_negative_count_breakpoint_refuses`.
...
Implementation: `metta._observe.diagnostics:explain`, receiving `space`.
...
Guarantees result type `(host-type metta._observe.diagnostics Explanation)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._observe.diagnostics:effect_plan`, receiving `space`.
...
Guarantees result type `(host-type metta._observe.diagnostics _ops_module.EffectPlan)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._observe.diagnostics:derivation`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._observe.diagnostics list) (%Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta._observe.diagnostics:why`, receiving `space`.
...
Implementation: `metta._observe.recording:record`, receiving `space`.
...
Guarantees result type `(host-type metta._observe.recording Recording)` with the answer shape, effect, and determinism above.
...
Implementation: `metta._observe.trace:trace`, receiving `space`.
...
| `filter` | `(host-union ((host-union ((host-union (Symbol String)) (host-apply (host-type metta._observe.trace Iterable) ((host-union (Symbol String)))))) NoneType))` | `None` | `values` | `keyword_only` |
| `timeout` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |
| `inferences` | `(host-union (Number NoneType))` | `None` | `values` | `keyword_only` |

Guarantees result type `(host-type metta._observe.trace Trace)` with the answer shape, effect, and determinism above.
...
Implementation: `metta.lint._analysis:lint`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta.lint._analysis list) ((host-type metta.lint._analysis Finding)))` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteCursor.__next__`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteCursor.to_arrow`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteCursor.__arrow_c_stream__`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteCursor.__iter__`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta.remote._client Iterator) (Atom))` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteCursor.close`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteCursor.__enter__`, receiving `method`.
...
Guarantees result type `(host-type metta.remote._client Self)` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteCursor.__exit__`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteSpace.delivers`, receiving `method`.
...
Guarantees result type `(host-union ((host-apply (host-type metta.remote._client tuple) (String String)) NoneType))` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteSpace.refusal`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteSpace.match`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteSpace.stream`, receiving `method`.
...
Guarantees result type `(host-type metta.remote._client RemoteCursor)` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteSpace.server_capabilities`, receiving `method`.
...
Guarantees result type `(host-apply (host-type metta.remote._client dict) (String %Undefined%))` with the answer shape, effect, and determinism above.
...
Implementation: `metta.remote._client:RemoteSpace.atoms`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteSpace.add`, receiving `method`.
...
Implementation: `metta.remote._client:RemoteSpace.add_many`, receiving `method`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `atoms` | `(host-apply (host-type metta.remote._client list) (Atom))` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta.remote._client:RemoteSpace.remove`, receiving `method`.
...
Implementation: `metta._history.saga:saga`, receiving `space`.

Assumes receiver state `live`.

| argument | MeTTa type | default | delivery | parameter kind |
|---|---|---|---|---|
| `receipts` | `(host-type metta._history.saga _space_face.Space)` | `required` | `values` | `positional_or_keyword` |
...
Implementation: `metta._history.world:reify`, receiving `space`.
...
Implementation: `metta._history.world:commit`, receiving `space`.
...
Implementation: `metta._history.world:blame`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta._history.world list) (Atom))` with the answer shape, effect, and determinism above.
...
Implementation: `metta_arrays_doors:install`, receiving `space`.
...
Guarantees result type `(host-apply (host-type metta_arrays_doors list) (String))` with the answer shape, effect, and determinism above.
...
Implementation: `metta_arrays_doors:uninstall`, receiving `space`.
...
Implementation: `metta_arrays_doors:ops`, receiving `space`.
...
Implementation: `metta_arrays_doors:backend`, receiving `space`.
...
Implementation: `metta_pandas:_RowsSugar.to_df`, receiving `value`.
...
Implementation: `metta_pandas:_AnswersSugar.to_df`, receiving `value`.
...
Implementation: `metta_polars:_RowsSugar.to_pl`, receiving `value`.
...
Implementation: `metta_polars:_AnswersSugar.to_pl`, receiving `value`.
...
Implementation: `metta_remote:connect`, receiving `none`.
...
| `headers` | `(host-union ((host-apply (host-type metta_remote dict) (String String)) NoneType))` | `None` | `values` | `keyword_only` |
| `ssl_context` | `%Undefined%` | `None` | `values` | `keyword_only` |

Guarantees result type `(host-type metta_remote Transport)` with the answer shape, effect, and determinism above.
...
Implementation: `metta_remote:serve`, receiving `space`.
...
| `spaces` | `(host-union ((host-apply (host-type metta_remote list) (String)) NoneType))` | `None` | `values` | `positional_or_keyword` |
| `token` | `(host-union (String NoneType))` | `None` | `values` | `keyword_only` |
| `authorize` | `(host-union ((host-apply (host-type metta_remote Callable) (((host-type metta_remote Request)) Bool)) NoneType))` | `None` | `values` | `keyword_only` |
| `ssl_context` | `%Undefined%` | `None` | `values` | `keyword_only` |
...
Guarantees result type `(host-type metta_remote Server)` with the answer shape, effect, and determinism above.
...
Implementation: `metta_tables:add`, receiving `space`.
...
Implementation: `metta_tables:declare`, receiving `space`.
...
Implementation: `metta_tables:accessors`, receiving `none`.
...
Guarantees result type `(host-apply (host-type metta_tables tuple) (String ...))` with the answer shape, effect, and determinism above.
...
Implementation: `metta_tables:sql_function`, receiving `none`.
